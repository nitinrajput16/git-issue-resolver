      ...
      <div className="card p-10 max-w-md w-full text-center shadow-sm">
        <div className="flex justify-center mb-6">
          <div className="w-16 h-16 bg-gray-900 dark:bg-white rounded-full flex items-center justify-center">
            <svg height="32" viewBox="0 0 16 16" className="fill-white dark:fill-gray-900" aria-hidden="true">
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-8 text-sm leading-relaxed">
          Connect your GitHub account and let AI analyze and resolve your issues instantly.
        </p>
